...
import static vts.psi.Types.*; // Note that is the class which is specified as `elementTypeHolderClass`
// in bnf grammar file. This will contain all other tokens which we will use.

%%

%public
%class VDLLexer // Name of the lexer class which will be generated.
...
<YYINITIAL> {
  ...
  // These tokens are generated using the `VDL.bnf` file and located in the SimpleTypes `class`.
  // These tokens are Parser uses these return values to match token squence to a parser rule.
//  "function"         { return IDE; } // This indicates that the `function` keyword is encountered.
